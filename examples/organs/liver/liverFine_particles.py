...
def createScene(rootNode):
    ...
    rootNode.addObject('CollisionResponse', name="ContactManager", response='FrictionContactConstraint') #Used with FreeMotionAnimationLoop
    rootNode.addObject('BlockGaussSeidelConstraintSolver', maxIterations=200, tolerance=1.0e-8 )
    rootNode.addObject('NewProximityIntersection', name='Intersection', alarmDistance='1.0', contactDistance='0.1')

...
pathScene = r'C:\projects\sofa_dev\sofa_plugins\MOR\tools\test\sofa_test_scene\liverFine_and_particles_with_gravity.py'
...
listObjToAnimate = []
listObjToAnimate.append(ObjToAnimate('actuatorLiver/actuatorLiver',doingNothing,duration=-1,**{'incr': 0.4, 'incrPeriod': 2.5, 'rangeOfAction': 6.2, 'angle': 0, 'rodRadius': 0.4}))
phase = []
phase.append(0)
nbIterations = 41
